...
# setwd('/media/yuanheng/SD-64g3/Downloads/backup2/HJA_analyses_Kelpie/HJA_scripts/15_predict_map')
	
pacman::p_load('dplyr', 'rgdal', 'raster','here','glue','corrplot','sjsdm','ggplot2')
	
source("source/irrAB.r")
...
sjsdmV = '0.1.6' # package version
sjsdmVfolder = glue('sjsdm-{sjsdmV}')
	
datapath=here('..','12_sjsdm_general_model_outputs')
