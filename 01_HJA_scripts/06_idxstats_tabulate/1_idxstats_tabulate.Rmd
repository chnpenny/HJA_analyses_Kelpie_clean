...
# dir_create(file.path("..", "..", "02_Kelpie_maps", outputidxstatstabulatefolder))
...
idx_files <- list.files(Sys.glob(file.path("..", "..", "02_Kelpie_maps", idxstatsgenomecovfolder)), pattern = idxstatsfile, full.names = TRUE)

head(idx_files); cat("    ", length(idx_files), "total files")
    # Sys.glob:  [1] "../../02_Kelpie_maps/outputs_F2308_f0x2_q48_minimap2_outputs_20191219_kelpie2091217_vsearch97_filtered_geneious_filtered/076361-M1-S1_BDSW190602952-1a_F2308_f0x2_q48_sorted.bam_idxstats.txt" and so on
...
# write_csv(idx_summ, file.path("..", "..", "02_Kelpie_maps", outputidxstatstabulatefolder, "idx_summ.csv"))
``` 
...
genomecov_files <- list.files(Sys.glob(file.path("..", "..", "02_Kelpie_maps", idxstatsgenomecovfolder)), pattern = genomecovfile, full.names = TRUE)

head(genomecov_files); cat("    ", length(genomecov_files), "total files")
    # Sys.glob is used to generate:  
    # [1] "../../02_Kelpie_maps/outputs_F2308_f0x2_q48_minimap2_outputs_20191219_kelpie2091217_vsearch97_filtered_geneious_filtered/076361-M1-S1_BDSW190602952-1a_F2308_f0x2_q48_sorted_genomecov_d.txt.gz"
...
loadFile2 <- function(x) {
    ...
    # e.g. "../../02_Kelpie_maps/HOBO-064-M1-S1_BDSW190603110-1a_F2308_f0x2_q48_sorted_genomecov_d.txt.gz"
